...
const data = {
  subscribers_gained: {
    analyticsData: [
        { device: 'Mobile App', icon: 'MonitorIcon', color: 'primary', sessionsPercentage: 58.6, comparedResultPercentage: 2 },
        { device: 'Binafif.Store', icon: 'SmartphoneIcon', color: 'warning', sessionsPercentage: 34.9, comparedResultPercentage: 8 },
        { device: 'Binafif.CC', icon: 'TabletIcon', color: 'danger', sessionsPercentage: 6.5, comparedResultPercentage: -5 },
    ],
  ...
  productsOrders: {
    analyticsData: [ 
        ...
        { 'orderType': 'Cancelled ', 'counts': 4758, color: 'danger' },
    ],
    series: [70, 52, 26],
  },
  customers: {
    analyticsData: [
        ...
        { 'customerType': 'Returned Once', 'counts': 258, color: 'warning' },
        { 'customerType': 'Returning +2 Times', 'counts': 149, color: 'danger' },
    ],
    series: [690, 258, 149],
  },
  salesRadar: {
