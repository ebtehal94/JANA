                ...
                <vx-card class="p-4 login-tabs-container rounded-corner shadow-none">
                    ...
                    <div class="vx-row">
                        ...
                        <div class="flex items-end mb-2 ml-4">
                            <span class="leading-none font-semibold text-sm">{{$i18n.locale == "en" ? "Passport Information" : "  بيانات جواز السفر "}}</span>
                        </div>
                    </div>
                    <div class="vx-row">
                        <div class="vx-col w-full lg:w-1/3">
  ...
  export default{
    ...
    methods: {
      save_data() {
        ...
        axios.post('https://MUQEEM-API-URL/api/v1/update-information/extend')
          .then((response) => {
