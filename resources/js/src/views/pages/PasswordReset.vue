              ...
              <div slot="no-body" class="full-page-bg-color">
                  <div class="vx-row">
                      ...
                      <div class="vx-col sm:w-full md:w-full lg:w-1/2 mx-auto self-center d-theme-dark-bg">
                          <div class="p-8">
                              <div class="vx-card__title mt-4 mb-8">
                                  <h4 class="mb-4">{{$t('ResetPassword')}}</h4>
                              </div>
                              <vs-input type="email" :label-placeholder="$t('Email')" v-model="email" class="w-full mt-4" />
                              ...
                              <vs-input :label-placeholder="$t('ConfirmPassword')" type="password" v-validate="'min:6|confirmed:password'"
                                data-vv-validate-on="blur" data-vv-as="password" name="confirm_password"
                                v-model="confirm_password" class="w-full mt-4 mb-8" />
                              <span class="text-danger text-sm">{{ errors.first('confirm_password') }}</span>

                              <vs-button type="border" to="/login" class="px-4 w-full md:w-auto">{{$t('BackToLogin')}}</vs-button>
                              <vs-button @click="forgotPassword()" :disabled="email.length <= 0" class="float-right px-4 w-full md:w-auto mt-3 mt-4 md:mt-0 md:mb-0">{{$t('Send')}}</vs-button>
                          </div>
                      </div>
                  </div>
              </div>
